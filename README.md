...
wget https://raw.githubusercontent.com/KULLANICI_ADINIZ/REPO_ADINIZ/main/openvpn-install.sh -O openvpn-install.sh
...
./openvpn-install.sh
```
*(GitHub'da yayınladıktan sonra yukarıdaki linki kendi deponuzun linkiyle değiştirmeyi unutmayın.)*
